...
export default function Home() {
  ...
  return (
    <div
  className="bg-cover h-155 bg-center flex items-center justify-center"
>
  <div className="flex flex-col items-center justify-center h-[calc(100vh-4rem)] text-center fade-in">
    ...
    <p className="text-gray-500 mb-6 max-w-md">
      Track your nutrition, monitor progress, and stay healthy with <span className="font-bold ">Eat'O</span>🍏 
    </p>
